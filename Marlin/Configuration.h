...
#define STRING_CONFIG_H_AUTHOR "boylie3d" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -25.4, -50.9, 0 }
...
//#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_Z_HOP       4.0        // (mm) Z height of nozzle between tramming pointsZ_SAFE_HOMING 
